...
import 'package:bakerybrown/wholeSaler/accountsScreen/accountDashScreen.dart';
import 'package:bakerybrown/wholeSaler/dashboard_view/profileScreen.dart';
import 'package:bakerybrown/wholeSaler/orderScreens/orderScreen.dart';
...
class WholesalerDashBoardScreen extends StatefulWidget {
  ...
  bool? isFromHome;
  int?index;
  WholesalerDashBoardScreen({Key? key, this.id, this.isFromHome = false,this.index})
      : super(key: key);
      ...
      children: [
        ...
        BottomNavigationBar(
          ...
          items:  [
            ...
            BottomNavigationBarItem(
              icon: SvgPicture.asset(AppImages.shopHolder1Icon,height: 20,color: _selectedIndex==2?dark1BrownColor:textBrownColor,),
              label: 'Retailers',
            ),

            BottomNavigationBarItem(
              icon: SvgPicture.asset(AppImages.accountIcon,height: 20,color: _selectedIndex==3?dark1BrownColor:textBrownColor,),
              label: 'Account',
            ),
            BottomNavigationBarItem(
